    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('teaching_type', models.CharField(blank=True, choices=[('HOD', 'Hod'), ('P', 'Professor'), ('AP', 'Assistant Professor'), ('LS', 'Lab Staff')], max_length=3, null=True, verbose_name='Teaching Type')),
