...
class MyForm(forms.ModelForm):
    ...
    def clean_teaching_type(self):
        ...
        if teaching_type:
            # Check if the teaching_type is one of the specified choices
            valid_choices = ['HOD', 'P', 'AP', 'LS']
        else:
            raise forms.ValidationError(
    ...
    def clean_gender(self):
        ...
        if gender:
            # Check if the gender is one of the specified choices
    ...
    def clean_marital_status(self):
        ...
        if marital_status:
            # Check if the marital_status is one of the specified choices
            valid_choices = ['Married', 'Un Married']
            # if marital_status not in valid_choices:
            #     raise forms.ValidationError(
            #         "Marital Status must be one of the specified choices.")
        else:
            raise forms.ValidationError(
